	...
	<div>
		<div class="foucsList" v-for="list in foucsListArr">
			<div class="author">
				...
				<span class="userName">{{list.useName}}</span>
...
<style scoped>
	...
	.foucsList .author .userName {
		font-size: 16px;
		color: #262626;
	}
	.foucsList .author time{
		font-size:14px;
		color: #888888;
	}
	.foucsList .author .el-button{
		float: right;
		margin: 10px;
		background: #fc5b00;
		color: #fff;
