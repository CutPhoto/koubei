...
<style>
	...
	.nav .nav_x .nav_l li a{
		display: block;
		width: 100%;
		height: 70px;
	}
	.nav .nav_x .nav_l li img{
		height: 70px;
		width: 100%;
		background-size:100%;
	}
	...
	.nav .nav_x .nav_r li a{
		display: block;
		width: 100%;
		height: 70px;
	}
	.nav .nav_x .nav_r li img{
		height: 70px;
		width: 100%;
		background-size:100%;
	}
