...
<style>
	...
	.renqi_t .el-icon-view{
		color: red;
	}
	.renqi_t span:nth-child(2){
		color:red;
		font-size: 14px;
	}
	.renqi_t span:nth-child(3){
		padding: 3px;
		width:60px;
		height: 20px;
		font-size: 10px;
